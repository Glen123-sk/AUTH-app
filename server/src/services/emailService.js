...
class EmailService {
  ...
  async sendConfirmationEmail(userEmail, userName) {
    ...
    const confirmLink = `${process.env.APP_URL || 'https://nexl.me'}/confirm-email?token=${confirmToken}`;
  ...
  async sendWelcomeEmail(userEmail, userName) {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <p><a href="${process.env.APP_URL || 'https://nexl.me'}" style="background-color: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">Go to App</a></p>
